...
[assembly: SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1009:Closing parenthesis should be spaced correctly", Justification = "<Is unable to be fixed without causing another issue.>", Scope = "type", Target = "~T:SpreadsheetEngine.ExpTreeP")]
[assembly: SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1009:Closing parenthesis should be spaced correctly", Justification = "<Is unable to be fixed without causing another issue.>", Scope = "type", Target = "~T:SpreadsheetEngine.VariableNode")]
[assembly: SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1009:Closing parenthesis should be spaced correctly", Justification = "<Is unable to be fixed without causing another issue.>", Scope = "type", Target = "~T:SpreadsheetEngine.OperatorNode")]
[assembly: SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1009:Closing parenthesis should be spaced correctly", Justification = "<Is unable to be fixed without causing another issue.>", Scope = "type", Target = "~T:SpreadsheetEngine.ParenthesisOpNode")]
